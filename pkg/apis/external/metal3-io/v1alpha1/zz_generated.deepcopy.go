...
func (in *BareMetalHostSpec) DeepCopyInto(out *BareMetalHostSpec) {
	*out = *in
	...
	if in.AnsibleExtra != nil {
		in, out := &in.AnsibleExtra, &out.AnsibleExtra
		*out = new(CustomJSON)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomJSON) DeepCopyInto(out *CustomJSON) {
	*out = *in
	in.JSON.DeepCopyInto(&out.JSON)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomJSON.
func (in *CustomJSON) DeepCopy() *CustomJSON {
	if in == nil {
		return nil
	}
	out := new(CustomJSON)
