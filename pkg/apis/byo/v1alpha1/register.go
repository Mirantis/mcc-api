...
// +gocode:public-api=true
func EncodeMachineSpec(spec *BYOMachineProviderSpec) (*runtime.RawExtension, error) {
	if spec == nil {
...
// +gocode:public-api=true
func EncodeClusterSpec(spec *BYOClusterProviderSpec) (*runtime.RawExtension, error) {
	if spec == nil {
		return &runtime.RawExtension{}, nil
	}
