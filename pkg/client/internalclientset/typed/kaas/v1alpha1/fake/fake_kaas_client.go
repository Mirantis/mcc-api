...
import (
	v1alpha1 "github.com/Mirantis/mcc-api/v2/pkg/client/internalclientset/typed/kaas/v1alpha1"
...
func (c *FakeKaasV1alpha1) BareMetalHostCredentials(namespace string) v1alpha1.BareMetalHostCredentialInterface {
	return &FakeBareMetalHostCredentials{c, namespace}
}

func (c *FakeKaasV1alpha1) BootstrapRegions(namespace string) v1alpha1.BootstrapRegionInterface {
	return &FakeBootstrapRegions{c, namespace}
}
...
func (c *FakeKaasV1alpha1) ClusterPollStatuses(namespace string) v1alpha1.ClusterPollStatusInterface {
	return &FakeClusterPollStatuses{c, namespace}
}
...
func (c *FakeKaasV1alpha1) ContainerRegistries(namespace string) v1alpha1.ContainerRegistryInterface {
...
func (c *FakeKaasV1alpha1) GracefulRebootRequests(namespace string) v1alpha1.GracefulRebootRequestInterface {
	return &FakeGracefulRebootRequests{c, namespace}
}
...
func (c *FakeKaasV1alpha1) MachinePollStatuses(namespace string) v1alpha1.MachinePollStatusInterface {
	return &FakeMachinePollStatuses{c, namespace}
}
...
func (c *FakeKaasV1alpha1) MetalLBConfigs(namespace string) v1alpha1.MetalLBConfigInterface {
	return &FakeMetalLBConfigs{c, namespace}
}
...
func (c *FakeKaasV1alpha1) TLSConfigs(namespace string) v1alpha1.TLSConfigInterface {
	return &FakeTLSConfigs{c, namespace}
}
