...
var licensesResource = schema.GroupVersionResource{Group: "kaas.mirantis.com", Version: "v1alpha1", Resource: "licenses"}

var licensesKind = schema.GroupVersionKind{Group: "kaas.mirantis.com", Version: "v1alpha1", Kind: "License"}
...
func (c *FakeLicenses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.License, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(licensesResource, name), &v1alpha1.License{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLicenses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LicenseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(licensesResource, licensesKind, opts), &v1alpha1.LicenseList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLicenses) Create(ctx context.Context, license *v1alpha1.License, opts v1.CreateOptions) (result *v1alpha1.License, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(licensesResource, license), &v1alpha1.License{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.License), err
...
func (c *FakeLicenses) Update(ctx context.Context, license *v1alpha1.License, opts v1.UpdateOptions) (result *v1alpha1.License, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(licensesResource, license), &v1alpha1.License{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.License), err
...
func (c *FakeLicenses) UpdateStatus(ctx context.Context, license *v1alpha1.License, opts v1.UpdateOptions) (*v1alpha1.License, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(licensesResource, "status", license), &v1alpha1.License{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.License), err
...
func (c *FakeLicenses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(licensesResource, name), &v1alpha1.License{})
	return err
}
...
func (c *FakeLicenses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.License, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(licensesResource, name, pt, data, subresources...), &v1alpha1.License{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.License), err
