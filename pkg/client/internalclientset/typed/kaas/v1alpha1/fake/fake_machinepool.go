...
var machinepoolsResource = schema.GroupVersionResource{Group: "kaas.mirantis.com", Version: "v1alpha1", Resource: "machinepools"}

var machinepoolsKind = schema.GroupVersionKind{Group: "kaas.mirantis.com", Version: "v1alpha1", Kind: "MachinePool"}
...
func (c *FakeMachinePools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(machinepoolsResource, c.ns, name), &v1alpha1.MachinePool{})
